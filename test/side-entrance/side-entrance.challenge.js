...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const SideEntranceExploiter = await ethers.getContractFactory('SideEntranceExploiter', attacker);
        const exploiter = await SideEntranceExploiter.connect(attacker).deploy(this.pool.address);
